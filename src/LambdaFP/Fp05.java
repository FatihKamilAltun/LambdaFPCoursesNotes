...
public class Fp05 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("herhangiBirKursAdiVerilenKelimeyiIceriyorMu = " + herhangiBirKursAdiVerilenKelimeyiIceriyorMu(coursesList, "day"));
    ...
    //3) Ortalama puanı en yüksek olan kursu yazdırmak için
    ...
    //4) List öğelerini artan düzende ortalama puana göre sıralayın
    // ve ilk verilenleri atlayın
